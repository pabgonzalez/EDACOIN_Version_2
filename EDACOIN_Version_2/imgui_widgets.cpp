...
bool ImGui::MenuItem(const char* label, const char* shortcut, bool selected, bool enabled)
{
    ...
    else
    {
        ...
        if (selected) //CAMBIAMOS ESTA FUNCION, EDA, ITBA, CAMBIO
            RenderCheckMark(pos + ImVec2(window->MenuColumns.Pos[1] + extra_w + g.FontSize * 0.40f, g.FontSize * 0.134f * 0.5f), GetColorU32(enabled ? ImGuiCol_Text : ImGuiCol_TextDisabled), g.FontSize  * 0.866f);
    }
